...
class Blockchain(object):
    ...
    def new_transaction(self, sender, recipient, amount):
      '''
      Create a new transaction to transfer to another block
      
      :param sender: <STR> Name
      :param recipient: <STR> Person retrieving 
      :param amount: <INT> How much being sent
      :return: <INDEX> index of the block that holds the transaction
      '''
